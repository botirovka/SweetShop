    ...
    Column(
        ...
        Button(
            onClick = {
                scope.launch {
                    isLoading = true
                    val response = FirebaseRepository.register(email.trim(), password.trim())
                    isLoading = false
                    when (response) {
                        is Response.Success -> {
        ...
        Row(
            ...
            TextButton(onClick = {
                ...
                Text("Login", style = TextStyle(color = Brown, fontWeight = FontWeight.Bold))
            }
        }
...
fun SignUpScreenPreview() {
    SweetShopComposeTheme {
        SignUpScreenUI(navController = rememberNavController())
    }
}